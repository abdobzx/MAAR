...
# Imports conditionnels pour les agents corrigés
try:
...
async def lifespan(app: FastAPI):
    ...
    # Initialisation conditionnelle des agents corrigés
...
async def upload_documents(
    ...
    try:
        ...
        for file in files:
            ...
            from agents.ingestion.agent import IngestionAgent
            doc_type = IngestionAgent()._get_document_type(file.filename)
            ...
            # Création du document avec la structure correcte
            document = Document(
            ...
            document.metadata.title = file.filename
            document.metadata.file_size = file.size
